...
func capture() -> void:
	...
	game.store = SaveStore.new("res://tests/villa_v2_visual_profile.json")
	...
	await frame("res://tests/villa_v2_720x1280.png")
	root.size = Vector2i(450, 800)
	await frame("res://tests/villa_v2_450x800.png")
	game.free()
	print("VILLA V2 CAPTURES COMPLETE")
	quit()
